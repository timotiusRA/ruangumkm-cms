...
--
-- Host: 127.0.0.1
-- Generation Time: 13 Agu 2021 pada 13.31
...
INSERT INTO `business` (`BusinessID`, `BusinessCode`, `BusinessMatchID`, `BusinessLegalName`, `BusinessBrandName`, `BusinessMonthStand`, `BusinessYearStand`, `BusinessType`, `BusinessCategory`, `BusinessStatusBusiness`, `BusinessSector`, `BusinessDescription`, `BusinessNIB`, `BusinessTaxNumber`, `BusinessDirectorName`, `BusinessDirectorNIK`, `BusinessDirectorTaxNumber`, `BusinessKTPFile`, `BusinessNPWPFile`, `BusinessWebsite`, `BusinessInstagram`, `BusinessCreatedAt`, `BusinessCreatedBy`, `BusinessModifiedAt`, `BusinessModifiedBy`, `BusinessStatus`) VALUES
(15, 'B0001', 3, 'Ecommer Webinar', 'umkmRuang', 6, 2020, 'PT', 'micro', 'PKP', 'F&B', 'Bisnis ini bergerak dalam sector f&b yang sudah saya dirikan bersama istri saya dari tahun 2020 hingga sekarang', '123123123', '456456456', 'Fachri Ghiffary', '1230987312367098', '12323q41454544', 'images/businessKtpFile/1628830323443-BusinessKTPFile.png', 'images/businessNPWPFile/1628830323533-BusinessNPWPFile.png', 'ruangalternative.com', '@ruangumkm', '2021-08-13 11:52:03', 1, '2021-08-13 11:52:03', 0, 1);
...
CREATE TABLE `users` (
  ...
  `StatusResetPassword` tinyint(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(3, 0, '', '', 0, '0000-00-00 00:00:00', '', '', '', '', '', '', 0, 0, 0, '', '', 'fachri g', 'fachrighiffary@ruangalternative.com', '$2b$04$DDywhSNwz17j3TULxs8CeOqEXUOkjUhy7P/DNomDX1csTLFuhtkwm', 1, '2021-08-06 10:40:37', 0, '2021-08-06 10:40:37', 0, 1, 0),
(23, 0, '', '', 0, '0000-00-00 00:00:00', '', '', '', '', '', '', 0, 0, 0, '', '', 'ghiffary', 'ghiffaryfachri@gmail.com', '$2b$05$E6VH3YNkkO642IZ3FsOK1u1KBWP7HfT8t8YGct0tYTsOkNZNnZ7um', 1, '2021-08-13 16:36:19', 0, '2021-08-13 16:36:19', 0, 0, 0);
...
--
ALTER TABLE `business`
  MODIFY `BusinessID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
--
...
--
ALTER TABLE `events_orders`
  MODIFY `OrdersID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
--
