...
--
-- Host: 127.0.0.1
-- Generation Time: 18 Agu 2021 pada 06.15
...
CREATE TABLE `users` (
  ...
  `UserCreatedBy` bigint(20) DEFAULT NULL,
...
(31, 0, 'ghiffary', NULL, 1, '1997-06-13 00:00:00', NULL, 'Jawa Tengah', NULL, NULL, NULL, NULL, '987123987123', NULL, NULL, '330504150697000', '213987765312', 'ghiffary', 'ghiffaryfachri@gmail.com', '$2b$05$HoeP/M2c3uqOwktnFPvW5On3Vpd6hiDSMiIjF8ZFD6BiVN9ShhQD6', 1, '2021-08-17 12:16:47', NULL, '2021-08-18 11:03:36', 31, 1, 0);
...
--
ALTER TABLE `pekanraya`
  MODIFY `PekanRayaID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `pekanusaha`
--
ALTER TABLE `pekanusaha`
  MODIFY `PekanUsahaID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
